  ...
  return (
    <div className=" flex justify-center mx-5 my-20 p-5">
      <form onSubmit={(e)=>e.preventDefault()} className='flex flex-col p-5 m-5 border border-solid w-3/4 md:w-80 rounded-lg shadow-2xl shadow-amber-400 hover:scale-125 hover:shadow-amber-300 transition-transform duration-1000'>
        <h1 className='p-2 m-2 font-extrabold text-2xl'>Login</h1>
      ...
      <button onClick={handleLogin} className="btn btn-primary p-2 m-2">Log in</button>
      <p className="p-2 m-2">New to DevFinder? <span className="cursor-pointer text-blue-500 hover:text-blue-700 font-semibold" onClick={() => navigate('/signup')}>Signup Now</span></p>
    </div>
    </form>
